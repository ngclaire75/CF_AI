...
try:
    ...
    controls = [
        ...
        ('ISO-A.9.1',  'Access Control Policy',              'ISO 27001', 'Access Control',  'implemented', 'IT Admin',         date_str(2),   'Custom',    'SOC 2 CC 6.1'),
        ...
        ('NIST-PR.1',  'Protect: Identity Management',       'NIST CSF',  'Identity',        'implemented', 'IT Admin',         date_str(7),   'Custom',    'ISO A.9.1'),
        ('NIST-DE.1',  'Detect: Anomaly Detection',          'NIST CSF',  'Detection',       'in_progress', 'Security Team',    date_str(-10), 'Custom',   'ISO A.16.1'),
        ('SOC2-CC6.1', 'Logical & Physical Access Controls', 'SOC 2',     'Access Control',  'implemented', 'CISO',             date_str(15),  'Custom',    'ISO A.9.2'),
        ('SOC2-CC7.1', 'System Monitoring',                  'SOC 2',     'Monitoring',      'implemented', 'DevOps',           date_str(12),  'Custom',    'NIST DE.CM-1'),
